...
const ALL_FIELDS = ['Name','FathersName','ClassN','Section','Year','DateofBirth','AdmissionNumber','StudentID','RollNumber','EmployeeID','ContactNumber','EmergencyContact','BloodGroup','UploadYourPhoto','PrincipalSignature','Address','ModeOfTransportation','Designation','AadharCard','Department','EmailId']
const ICONS = {Name:'👤',FathersName:'👨',ClassN:'🏫',Section:'📌',Year:'📅',DateofBirth:'🎂',AdmissionNumber:'🔢',StudentID:'🪪',RollNumber:'🎯',EmployeeID:'🪪',ContactNumber:'📱',EmergencyContact:'🚨',BloodGroup:'🩸',UploadYourPhoto:'📷',PrincipalSignature:'✍️',Address:'📍',ModeOfTransportation:'🚌',Designation:'💼',AadharCard:'🪪',Department:'🏢',EmailId:'✉️'}
